...
#define CLEAR_FPTR_TAG(tag) 0
#define CLEAR_TAG(reg, tag) WRITE_REG_TAG(reg, CLEAR_FPTR_TAG(tag))
#endif // TAG_POLICY_FPTR_TAGS
...
#elif defined TAG_POLICY_FPTR_TAGS
  #define TAG_ADD(tag1, tag2) ((tag1) ^ (tag2))
  #define TAG_SUB(tag1, tag2) ((tag1) ^ (tag2))
  #define TAG_ARITH(tag1, tag2) CLEAR_FPTR_TAG(((tag1) & (tag2)))
  #define TAG_LOGIC(tag1, tag2) CLEAR_FPTR_TAG(((tag1) & (tag2)))
#else
  #define TAG_ADD(tag1, tag2) ((tag1) ^ (tag2))
  #define TAG_SUB(tag1, tag2) ((tag1) ^ (tag2))
  #define TAG_ARITH(tag1, tag2) ((tag1) & (tag2))
  #define TAG_LOGIC(tag1, tag2) ((tag1) & (tag2))
#endif // TAG_POLICY_NO_RETURN_COPY || TAG_POLICY_FPTR_TAGS
